...
Professionals and students want a live, bite‑sized way to learn a new skill from a peer, but existing platforms require long onboarding, scheduling gymnastics, or paid subscriptions.
...
services:
  - name: api
    github:
      repo: Two-Weeks-Team/skillswap-lite
      branch: master
